...
// typography config matching the PDF export
const DOCX_STYLES = {
  fonts: {
    body: "Charter",
    heading: "Inter",
...
// process markdown content into docs paragraphs
          ...
          paragraphs.push(
            new Paragraph({
              ...
              style: {
                ...
                size: fontSize * 2, // docx use half points
              },
            })
          );
...
// typography configuration for ebook styling
const TYPOGRAPHY = {
  fonts: {
    serif: "Times-Roman",
  ...
  for (let i = 0; i < tokens.length; i++) {
    ...
    try {
      if (token.type === "heading_open") {
        ...
        // Find the inline content in the list item
